...
const educationData: EducationItem[] = [
  {
    ...
    period: "2024 - 2026",
    description: "Currently pursuing higher secondary education with a focus on advanced academic excellence and preparing for future specialization in technology and design."
  },
  {
    institution: "Habib Public School",
    degree: "Secondary School Certificate (Matriculation)",
    period: "2022 - 2024",
    description: "Successfully completed secondary education with a distinguished score of 85% in the Secondary School Certificate (SSC) examinations."
  }
];
